  ...
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <form method="post" action="{{route('teacher.addModule')}}">
                  @csrf
...
<div class="modal fade" id="uploadModuleModal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <div class="modal-body">
            <!-- Form inside the modal -->
            <form method="post" action="{{ route('teacher.addImage') }}" enctype="multipart/form-data">
                @csrf
  ...
  $(document).ready(function() {
      ...
      $(document).on('click', '.deleteModuleBtn', function() {
          ...
          if (confirmDelete) {
              ...
              $.ajax({
                  url: '/teacher/delete-module/' + moduleId,
                  type: 'GET',
                  success: function(response) {
